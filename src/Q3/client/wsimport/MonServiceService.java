 ...
 * 
 */
@WebServiceClient(name = "MonServiceService", targetNamespace = "http://serveur.Q3.src/", wsdlLocation = "http://localhost:8080/WSSOAP/MonServiceService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/WSSOAP/MonServiceService?wsdl");
